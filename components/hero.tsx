    ...
    <section className="relative bg-white overflow-hidden">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[600px]">
          {/* Left Content */}
          <div className="pl-6 lg:pl-0 pr-6 lg:pr-12 py-12 lg:py-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/about" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium text-center">
                Tentang Sekolah
              </Link>
              <Link
                href="/contact"
                className="border border-gray-600 text-gray-700 hover:bg-gray-50 px-8 py-3 rounded-full font-medium bg-transparent block text-center"
              >
                Hubungi Kami
              </Link>
            </div>
